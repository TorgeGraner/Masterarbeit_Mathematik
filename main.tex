...
\begin{document}
    ...
    \chapter{Einleitung}
        \input{Kapitel/Kap-Einleitung}

    \chapter{Mannigfaltigkeiten}
        \input{Kapitel/Kap-Mannigfaltigkeiten}

    \chapter{Verklebung von Mannigfaltigkeiten}
        \input{Kapitel/Kap-VerklebungVonMannigfaltigkeiten}
     
    \chapter{Etwas Homotopietheorie}
        \input{Kapitel/Kap-Homotopietheorie}

    \chapter{Chirurgie}
        \input{Kapitel/Kap-Chirurgie.tex}

    \chapter{Chirurgie in ungerader Dimension}
        \input{Kapitel/Kap-DoppeltUngeradeDimension.tex}

    \chapter{Die Berechnung von \texorpdfstring{\(P^{4m}\)}{TEXT}}
        \input{Kapitel/Kap-DoppeltGeradeDimension.tex}

    \chapter{Die Berechnung von \texorpdfstring{\(P^{4m+2}\)}{TEXT}}
        \input{Kapitel/Kap-EinfachGeradeDimension.tex}

    \chapter{Die Berechnung von \texorpdfstring{\(\Theta_n\)}{TEXT}}
        \input{Kapitel/Kap-KervaireMilnorGruppe}
